	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('categories') ?>"><?= $this->lang->line('categories') ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('products') ?>"><?= $this->lang->line('products') ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('about') ?>"><?= $this->lang->line('about') ?></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('contact') ?>"><?= $this->lang->line('contact') ?></a>
				</li>
			</ul>

			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				<li class="nav-item">
					<a class="nav-link position-relative me-3" href="#"><i
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item"
								   href="<?= base_url('profile') ?>"><?= $this->lang->line('profile') ?></a></li>
							<li>
								<hr class="dropdown-divider">
							</li>
							<li><a class="dropdown-item"
								   href="<?= base_url('logout') ?>"><?= $this->lang->line('logout') ?></a></li>
							<li>
						</ul>
					</li>
