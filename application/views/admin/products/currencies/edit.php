			...
			<div class="row justify-content-center">
				...
				<div class="col-12 col-md-10" data-aos="zoom-in-up">
					<div class="border rounded p-4">
						...
						<?= form_open('admin/products/currencies/edit/' . $currency->id) ?>
								...
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="text" id="name" name="name"
											   value="<?= set_value('name', $currency->name) ?>"
								...
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="text" id="code" name="code" maxlength="3"
											   value="<?= set_value('code', $currency->code) ?>"
							...
							<div class="col-12 col-md-5 mb-3 mb-md-0">
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="text" id="symbol" name="symbol" maxlength="1"
											   value="<?= set_value('symbol', $currency->symbol) ?>"
