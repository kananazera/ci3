			...
			<div class="row justify-content-center">
				...
				<div class="col-12 col-md-10" data-aos="zoom-in-up">
					<div class="border rounded p-4">
						...
						<?= form_open('admin/products/edit/' . $product->id) ?>
									...
									<div class="input-group">
										...
										<select name="category_id" id="category_id"
											...
											<?php foreach ($categories as $row) : ?>
												<option
													value="<?= $row->id ?>" <?= ($product->category_id == $row->id) ? 'selected' : '' ?>><?= $row->name ?></option>
											<?php endforeach ?>
										</select>
									</div>
								...
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="text" id="slug" name="slug"
											   value="<?= set_value('slug', $product->slug) ?>"
								...
								<div class="mb-3">
									<div class="input-group">
										<input type="checkbox" id="is_active" name="is_active"
											   class="form-check-input rounded" <?= ($product->is_active == 1) ? 'checked' : '' ?>>
										<label for="is_active"
								...
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="number" id="quantity" name="quantity"
											   value="<?= set_value('quantity', $product->quantity) ?>"
							...
							<div class="col-12 col-md-4">
								...
								<div class="mb-3">
									...
									<div class="input-group">
										...
										<input type="number" id="discount_rate" name="discount_rate" step="0.01"
											   value="<?= set_value('discount_rate', $product->discount_rate) ?>"
						...
						<div class="mb-3">
							...
							<div class="input-group">
								...
								<textarea rows="10" id="description" name="description"
										  ...
										  required><?= set_value('description', $product->description) ?></textarea>
							</div>
