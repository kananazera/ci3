				...
				<div class="col-12 col-md-10" data-aos="zoom-in-up">
					<div class="border rounded p-4">
						...
						<h3 class="text-center mb-3">
							<?= $this->lang->line('edit_order_status') ?>
						</h3>

						<div class="mb-3 text-end">
							<a href="<?= base_url('admin/orders/statuses') ?>"
							   class="btn btn-dark"><i
									class="bi bi-list"></i> <?= $this->lang->line('order_statuses') ?></a>
						</div>
						...
						<?= form_open('admin/orders/statuses/edit/' . $order_status->id) ?>

						<div class="row">
							<div class="col-12 col-md-5 mb-3 mb-md-0">
								<div class="mb-3">
									<label for="name" class="mb-1"><?= $this->lang->line('order_status') ?></label>
									<div class="input-group">
										<span class="input-group-text"><i class="bi bi-bounding-box-circles"></i></span>
										<input type="text" id="name" name="name"
											   value="<?= set_value('name', $order_status->name) ?>"
