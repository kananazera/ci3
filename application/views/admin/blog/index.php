							...
							<div class="col-12 col-md-6 text-center text-md-end ">
								<a href="<?= base_url('admin/blog/create') ?>"
								   class="btn btn-dark"><i
										class="bi bi-plus-circle"></i> <?= $this->lang->line('create_blog') ?></a>
							</div>
						</div>
							...
							<table class="table">
								...
								<?php foreach ($blog as $row) : ?>
									<tr>
										...
										<td><a class="btn btn-sm btn-dark" href="<?= base_url('admin/blog/edit/' . $row->id) ?>"><i
													class="bi bi-pencil"></i></a></td>
										<td><a class="btn btn-sm btn-dark" href="<?= base_url('admin/blog/delete/' . $row->id) ?>"
											   onclick="if(confirm('<?= $this->lang->line('blog_delete_confirm') ?>')){return true;}else{return false;}"><i
